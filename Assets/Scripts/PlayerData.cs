...
public class PlayerData
{
    ...
    static public void NewSave()
    {
        ...
        m_Instance.characters.Add("Red car");
    ...
    public void Read()
    {
        ...
        for (int i = 0; i < charCount; ++i)
        {
            ...
            if (ver < 15)
            {
                if (charName == "Trash Cat")
                {
                    charName = "Red car";
                }
                else if (charName.Contains("Raccoon"))
                {
                    charName = "Blue car";
                }
                else continue;
        ...
        if (ver < 13)
        {
            usedCharacter = usedCharacter % characters.Count;
        }
