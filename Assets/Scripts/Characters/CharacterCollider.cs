...
public class CharacterCollider : MonoBehaviour
{
    ...
    protected const int k_ZoneColliderLayerIndex = 16;
    ...
    protected void OnTriggerEnter(Collider c)
    {
		...
		else if(c.gameObject.layer == k_ZoneColliderLayerIndex)
        {
			ZoneCollider zoneCollider = c.GetComponent<ZoneCollider>();
			zoneCollider.SwitchZone();
		}
    }
